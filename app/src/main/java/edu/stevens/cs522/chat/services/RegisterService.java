...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        Notification.Action cancelButton = new Notification.Action.Builder(icon, getText(R.string.register_cancel_button_label), pendingCancelIntent).build();
        notificationBuilder.addAction(cancelButton);
        /*
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationBuilder.setContentText(getText(R.string.registered_notification_message)).build();
                        Notification notification2 = notificationBuilder.build();
